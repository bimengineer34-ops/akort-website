    ...
    features: [
      {
        ...
        image: 'https://images.unsplash.com/photo-1618385455730-2571c38966b7?auto=format&fit=crop&w=1200&q=80',
        imageAlt: 'BIM modelinde yapısal sistemin ekranda incelenmesi',
      },
      {
        icon: 'tabler:network',
        title: 'MEP Coordination',
        description: 'Mekanik, elektrik ve sıhhi tesisat disiplinlerinin dijital ortamda senkronizasyonu.',
        image: 'https://images.unsplash.com/photo-1543674892-7d64d45df18b?auto=format&fit=crop&w=1200&q=80',
        imageAlt: 'Mekanik ve elektrik tesisat hatlarının yakın çekimi',
      },
      {
        icon: 'tabler:alert-triangle',
        title: 'Clash Detection',
        description: 'Disiplin çakışmalarının uygulama öncesinde tespit edilmesi ve çözülmesi.',
        image: 'https://images.unsplash.com/photo-1580982330720-bd5e0fed108b?auto=format&fit=crop&w=1200&q=80',
        imageAlt: 'Koordineli BIM modelinin ekranda incelenmesi',
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1581094488379-6a10d04c0f04?auto=format&fit=crop&w=1200&q=80',
        imageAlt: 'Sahada imalat çizimlerinin birlikte incelenmesi',
      },
      {
        icon: 'tabler:file-check',
        ...
        imageAlt: 'Metraj ve ölçüm verilerinin kayıt altına alınması',
      },
      {
        icon: 'tabler:sitemap',
        title: 'Dijital İş Akışları',
        description: 'Proje verilerinin tüm paydaşlar arasında tutarlı biçimde yönetilmesi.',
        image: 'https://images.unsplash.com/photo-1778074762022-c33cc42f79ae?auto=format&fit=crop&w=1200&q=80',
        imageAlt: 'Saha ekibinin proje verileri üzerinde koordinasyonu',
      },
      {
        ...
        image: 'https://images.unsplash.com/photo-1601342630314-8427c38bf5e6?auto=format&fit=crop&w=1200&q=80',
        imageAlt: 'Tablet üzerinde iş programı ve zaman çizelgesi',
      },
      {
        icon: 'tabler:scan',
        ...
        image: 'https://images.unsplash.com/photo-1752056012968-5b094676afa9?auto=format&fit=crop&w=1200&q=80',
        imageAlt: '3B lazer tarama cihazı ile saha verisi toplama',
      },
      {
        icon: 'tabler:route',
        ...
        image: 'https://images.unsplash.com/photo-1778074762033-c6595907684d?auto=format&fit=crop&w=1200&q=80',
        imageAlt: 'Saha ekibinin dijital dönüşüm sürecinde birlikte çalışması',
      },
      {
        ...
        imageAlt: 'Proje verilerinin gösterge panelinde görselleştirilmesi',
      },
    ],
